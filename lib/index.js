...
var FileLocalStroage = /** @class */ (function () {
    ...
    Object.defineProperty(FileLocalStroage.prototype, "listJson", {
        /**
         * 获取数组形式的mapJson数据
         */
        get: function () {
            var _this = this;
            return Object.keys(this.mapJson).map(function (_) { return _this.mapJson[_]; });
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(FileLocalStroage.prototype, "keys", {
        ...
        get: function () {
            ...
            return fs.readdirSync(this.stroagePath, {
                withFileTypes: true
            }).filter(function (_) { return _.isFile(); }).map(function (_) {
                return decodeURIComponent(path.basename(_.name, _this.suffix));
            });
        },
        enumerable: false,
        configurable: true
